...
function blue_water_setup() {
	/*
		...
		* If you're building a theme based on Blue Water, use a find and replace
		* to change 'blue-water' to the name of your theme in all the template files.
		*/
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'blue-water' ),
		)
	);
